...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Enhanced primary color with better dark mode variants
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      animation: {
        ...
        'theme-fade': 'themeFade 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
      ...
      keyframes: {
        ...
        // New theme transition keyframes
        themeFade: {
          '0%': { opacity: '0.8' },
          '50%': { opacity: '0.6' },
          '100%': { opacity: '1' },
      ...
      boxShadow: {
        ...
        'dark-soft': '0 2px 15px -3px rgba(0, 0, 0, 0.3), 0 10px 20px -2px rgba(0, 0, 0, 0.15)',
        'dark-medium': '0 4px 25px -5px rgba(0, 0, 0, 0.4), 0 10px 10px -5px rgba(0, 0, 0, 0.2)',
        'dark-large': '0 10px 50px -12px rgba(0, 0, 0, 0.6)',
