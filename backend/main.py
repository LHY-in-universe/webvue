...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:5173", "http://localhost:5174", "http://127.0.0.1:3000", "http://127.0.0.1:5173", "http://127.0.0.1:5174", "http://175.178.24.56:5173"],
...
app.add_middleware(
    ...
    allowed_hosts=["localhost", "127.0.0.1", "0.0.0.0", "175.178.24.56"]
)
